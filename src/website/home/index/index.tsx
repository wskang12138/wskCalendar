...
import img_box from '@/website/assets/images/png/box.png';
import img_code from '@/website/assets/images/png/code.png';
import img_tree from '@/website/assets/images/png/tree.png';
import ic_book from '@/website/assets/images/svg/book.svg';
import './index.scss';
    ...
    <View className='home-pages'>
      <View className='pages__banner'>
        <View className='banner__supplement'>
          ...
          <View className='supplement__text'>日历插件库</View>
        </View>
